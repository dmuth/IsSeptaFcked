...
exports.getMessage = function(data) {
	...
	if (status == "fucked") {
		...
		retval = util.format(
			"All %d bus lines that we know about are running!",
			num_total);
		...
		//
		retval = "No bus data was returned to me by SEPTA's API.";
		...
		//
		retval = "Unable to retrieve bus status in the last few minutes.";
